...
if __name__ == "__main__":
    ...
    dimEntidadEmisorBono  = (
        p
        | 'Query Table dimEntidadEmisorBono' >> beam.io.ReadFromBigQuery(
            query='''
                ...
                where IdEntidadEmisora
                not in
                (select IdEntidadEmisora from afiliados-pensionados-prote.Datamart.dimEntidadEmisorBono)
                  ''',\
