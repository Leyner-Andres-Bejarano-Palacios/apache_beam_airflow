...
if __name__ == "__main__":
    ...
    dimInfPersonas  = (
        ...
        | 'Query Table Clientes' >> beam.io.ReadFromBigQuery(
            query='''
            SELECT a.CONSECUTIVO_CUPON as ConsecutivoCupon, GENERATE_UUID() as CuponesBonoID, b.EstadoCuponID
            ...
            where CONSECUTIVO_CUPON
            NOT IN
            (SELECT a.CONSECUTIVO_CUPON as ConsecutivoCupon
            FROM `afiliados-pensionados-prote.afiliados_pensionados.SUPERCUPON` a
            )
                ''',\
