...
if __name__ == "__main__":
    ...
    dimEstadoCupon  = (
        ...
        | 'Query Table Clientes' >> beam.io.ReadFromBigQuery(
            query='''
                SELECT distinct ESTADO_CUPON as EstadoCupon FROM `afiliados-pensionados-prote.afiliados_pensionados.SUPERCUPON` 
                WHERE  ESTADO_CUPON NOT IN 
                (SELECT distinct EstadoCupon from afiliados-pensionados-prote.Datamart.dimEstadoCupon)
                ''',\
