...
dag = DAG(
    'dag-validaciones_factDefiniciones',
...
branch_op = BranchPythonOperator(
    ...
    templates_dict={"query": "SELECT * FROM `afiliados-pensionados-prote.Datamart.factDefiniciones`"},)

new_record_op = DataFlowPythonOperator(
task_id = 'new_records_task',
py_file = '/home/airflow/gcs/data/validaciones_factDefiniciones.py',
