...
dag = DAG(
    'dag-validaciones-dimEstadoPago',
...
branch_op = BranchPythonOperator(
    ...
    templates_dict={"query": "SELECT * FROM `afiliados-pensionados-prote.Datamart.dimEstadoPago`"},)
...
py_file = '/home/airflow/gcs/data/validaciones_dimEstadoPago.py',
