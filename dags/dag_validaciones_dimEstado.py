...
branch_op = BranchPythonOperator(
    ...
    templates_dict={"query": "SELECT * FROM `afiliados-pensionados-prote.Datamart.dimEstado`"},)

new_record_op = DataFlowPythonOperator(
task_id = 'new_records_task',
py_file = '/home/airflow/gcs/data/validaciones_dimEstado_newRecords.py',
...
py_file = '/home/airflow/gcs/data/validaciones_dimEstado.py',
gcp_conn_id='google_cloud_default',
dataflow_default_options={
    "project": 'afiliados-pensionados-prote',
    "temp_location": 'gs://bkt_prueba/temp',    
