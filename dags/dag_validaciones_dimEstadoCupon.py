...
dag = DAG(
    'dag-validaciones-dimEstadoCupon',
...
branch_op = BranchPythonOperator(
    ...
    templates_dict={"query": "SELECT * FROM `afiliados-pensionados-prote.Datamart.dimEstadoCupon`"},)
...
py_file = '/home/airflow/gcs/data/validaciones_dimEstadoCupon_newRecords.py',
...
py_file = '/home/airflow/gcs/data/validaciones_dimEstadoCupon.py',
gcp_conn_id='google_cloud_default',
dataflow_default_options={
    "project": 'afiliados-pensionados-prote',
    "temp_location": 'gs://bkt_prueba/temp',    
