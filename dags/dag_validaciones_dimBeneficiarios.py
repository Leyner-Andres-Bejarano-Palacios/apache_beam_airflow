...
dag = DAG(
    'dag-validaciones-beneficiarios',
...
branch_op = BranchPythonOperator(
    ...
    templates_dict={"query": "SELECT * FROM `afiliados-pensionados-prote.Datamart.dimBeneficiarios`"},)
...
py_file = '/home/airflow/gcs/data/validaciones_dimBeneficiarios_newRecords.py',
...
py_file = '/home/airflow/gcs/data/validaciones_dimBeneficiarios.py',
gcp_conn_id='google_cloud_default',
dataflow_default_options={
    "project": 'afiliados-pensionados-prote',
    "temp_location": 'gs://bkt_prueba/temp',
