...
branch_op = BranchPythonOperator(
    ...
    templates_dict={"query": "SELECT * FROM `afiliados-pensionados-prote.Datamart.dimTiempo`"},)
...
py_file = '/home/airflow/gcs/data/validaciones_dimTiempo.py',
